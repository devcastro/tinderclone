...
<>
  ...
  <div id='2' class="container px-5 py-28  xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <p class="leading-relaxed text-lg">
          My thirst levels are usually infinity and beyond. After 
          an evening spent on Lude, I not only have 5 dates planned, but
          also a boys hangout at my local bar. Did my life just change?</p>
      <span class="inline-block h-1 w-10 rounded bg-red-500 mt-8 mb-6"></span>
      <h2 class="text-gray-900 font-medium title-font tracking-wider text-sm">
          Tyler Baudelaire</h2>
  ...
  <div id='3' class="container px-5 py-28 mx-auto xl:w-1/2 lg:w-3/4 w-full text-center">
      ...
      <p class="leading-relaxed text-lg">
          I used to stare at my ceiling, not knowing where I was going. I now found the space
           I never thought I'd find. A place where I can share my passions and find new passions 
           and people interested in so many different fields.</p>
      <span class="inline-block h-1 w-10 rounded bg-red-500 mt-8 mb-6"></span>
      <h2 class="text-gray-900 font-medium title-font tracking-wider text-sm">
          George St-Pierre</h2>
